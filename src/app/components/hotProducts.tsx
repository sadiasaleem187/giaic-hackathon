  ...
  return (
    <header className="container mx-auto px-4 py-12 lg:py-16">
      <div className="relative grid grid-cols-1 gap-8 md:grid-cols-[auto_1fr]">
        <div className="writing-mode-vertical hidden text-xl font-bold tracking-wider text-zinc-900 md:block pt-6">
          EXPLORE NEW AND POPULAR STYLES
        </div>
        <div className="text-xl font-medium tracking-wider text-zinc-900 ">
